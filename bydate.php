...
<center>
  DATE: <input type="date" name="date12">
  <br>
  <br>
  <input type="submit" name="bdate" value="GET SELECTED VALUE" class="btn btn-primary"></center>
  <br>
</form>
    <?php
            ...
            <select name="hall1" >';
                $k=$_POST['date12'];
                $result ="SELECT hall_name FROM book WHERE date= '$k' AND status=1 ";
    ...
    while($row = $a-> fetch_assoc()) {
     ...
     echo '<input name="hh1" type="submit" value="get your data" class="btn btn-primary">';
